...
exports.usuarioController = {
    ...
    getUsers: (req, res) => {
        ...
        usuario_1.default.find({}, 'email username img')
            .skip(desde)
            .limit(7)
            .exec((err, usuarios) => {
            if (err) {
    ...
    getUser: (req, res) => {
        // @ts-ignore
        usuario_1.default.findById(req.usuarioId, 'username email img', (err, usuarioDB) => {
            if (err) {
    ...
    update: (req, res) => {
        ...
        let body = req.body;
        usuario_1.default.findByIdAndUpdate({ _id: id }, { username: body.username, email: body.email, role: body.role }, (err, usuarioActualizado) => {
            if (err) {
                return res.status(400).json({
                    ok: false,
